...
\Bi{Database hits / distinct records}{数据库命中／唯一记录} & 216/128; 75/47; 13/8; 10/7 & \Bi{Scopus; WoS; IEEE; ACM. Deduplication within each database.}{依次为 Scopus、WoS、IEEE、ACM；各库内部去重。}\\
\Bi{arXiv hits / distinct records}{arXiv 命中／唯一记录} & 544 / 346 & \Bi{API and keyword queries combined; deduplicated by arXiv base ID.}{合并 API 与关键词查询；按 arXiv 基础编号去重。}\\
